  ...
  return (
    <section id="features" className="section-spacing bg-secondary/50 relative overflow-hidden">
      ...
      <div className="page-container relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16 scroll-animate" data-animation="slide-up" data-delay="300">
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 transition-colors hover:text-primary">{feature.title}</h3>
